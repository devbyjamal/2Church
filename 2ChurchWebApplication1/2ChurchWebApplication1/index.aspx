<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="index.aspx.cs" Inherits="_2ChurchWebApplication1.index" %>
			...
			<header class="site-header">
				<div class="container">
					...
					<div class="main-navigation">
						...
						<ul class="menu">
							<li class="menu-item current-menu-item"><a href="index.aspx">Homepage <small>Lorem ipsum</small></a></li>
